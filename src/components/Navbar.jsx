...
function Navbar({ goTo }) {
  ...
  const NAV = [
    ...
    {
      label: t('nav.cheetahs'), page: 'nova-story',
      children: [
    ...
    {
      label: t('nav.conservation'), page: 'conservation',
      children: [
    ...
    {
      label: t('nav.get_involved'), page: 'volunteer',
      children: [
    ...
    <>
      ...
      <nav className={`nn ${solid || menuOpen ? 'nn--solid' : ''}`}>
        <div className="nn__wrap">
          ...
          <div className="nn__actions">
            <div className="nn__lang">
              <button className={`nn__lang-btn${lang === 'it' ? ' nn__lang-btn--active' : ''}`} onClick={() => i18n.changeLanguage('it')}>IT</button>
              <span className="nn__lang-sep">|</span>
              <button className={`nn__lang-btn${lang === 'en' ? ' nn__lang-btn--active' : ''}`} onClick={() => i18n.changeLanguage('en')}>EN</button>
            </div>
      ...
      <div className={`ovmenu ${menuOpen ? 'ovmenu--open' : ''}`} aria-hidden={!menuOpen}>
        ...
        <div className="ovmenu__foot">
          ...
          <div className="ovmenu__lang">
            <button className={lang === 'it' ? 'active' : ''} onClick={() => i18n.changeLanguage('it')}>IT</button>
            <span>|</span>
      ...
      <style>{`
        ...
        .nn__lang { display: flex; align-items: center; gap: 0.2rem; }
        .nn__lang-btn {
        ...
        .nn__lang-btn:hover { color: rgba(255,255,255,0.75); }
        .nn__lang-btn--active { color: var(--gold-light) !important; }
        .nn__lang-sep { color: rgba(255,255,255,0.15); font-size: 0.6rem; }
        ...
        /* Each row has overflow hidden so text sweeps up */
        .ovmenu__row {
          overflow: hidden;
        ...
        .ovmenu__link em { font-style: italic; font-weight: 400; color: var(--gold-light); }
        ...
        .ovmenu__lang button:hover { color: rgba(255,255,255,0.7); }
        .ovmenu__lang button.active { color: var(--gold-light); }
        .ovmenu__lang span { color: rgba(255,255,255,0.15); font-size: 0.65rem; }
        .ovmenu__socials { display: flex; gap: 1.5rem; }
        .ovmenu__socials a {
          font-size: 0.78rem;
        ...
        @media (max-width: 480px) {
          ...
          .ovmenu__lang { margin-left: 0; }
          .ovmenu__socials { display: none; }
        }
      `}</style>
    </>
  )
