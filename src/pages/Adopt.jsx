              ...
              {ANIMALS.map(a => (
                  ...
                  >
                    <div style={{ width: '100%', aspectRatio: '4 / 3', overflow: 'hidden' }}>
                      <img src={a.img} alt={a.name} style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
                    </div>
                    <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                      ...
                      <p style={{ fontSize: '0.88rem', color: '#555', lineHeight: '1.6', fontWeight: 300, marginBottom: '1.5rem', flexGrow: 1 }}>{a.desc}</p>
