const POSTS = [
  {
    ...
    excerpt: 'Grande gioia nella riserva: la nostra femmina Amira ha dato alla luce three cuccioli sani. Il team veterinario li monitora 24 ore su 24. Aggiornamenti in arrivo.',
      ...
      <>
        ...
        <div className="page-content">
          <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 1.5rem' }}>
            ...
            <div className="programs-grid" style={{ display: 'grid', gap: '2rem', marginTop: '0.5rem' }}>
              {POSTS.map(p => (
                  <div
                      key={p.title}
                      style={{
