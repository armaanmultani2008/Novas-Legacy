...
const ANIMAL_NAMES = ['Nova','Shira','Ghost Pack','Tumelo','Spirit','Sandy','Caracal','Serval']
...
function Home({ goTo }) {
  ...
  const testiLocations  = t('home.testi_locations',   { returnObjects: true })
  const accomTitles     = t('home.accom_titles',      { returnObjects: true })
  const accomDescs      = t('home.accom_descs',       { returnObjects: true })
  const accomIcons      = t('home.accom_icons',       { returnObjects: true })

  const GALLERY_IMGS = GALLERY_SRCS.map((src, i) => ({ src, caption: galleryCaptions[i] }))
  const ANIMALS_MARQUEE = ANIMAL_SRCS.map((src, i) => ({ src, name: ANIMAL_NAMES[i], role: animalRoles[i] }))
  const PROGRAMS = PROG_PAGES.map((page, i) => ({
    tag: progTags[i], title: progTitles[i], desc: progDescs[i], page,
    img: [IMG.progRun, IMG.progVol, IMG.progChalet, IMG.progInt, IMG.progAdopt, IMG.progBreed][i],
  }))
  const TESTIMONIALS = testiQuotes.map((quote, i) => ({
    quote, name: testiNames[i], location: testiLocations[i], stars: 5,
  }))
  ...
  return (
    <>
      ...
      <div className="alert-bar">
        ...
        <p dangerouslySetInnerHTML={{ __html: t('home.alert_text', {
      ...
      <section className="what-we-do">
        <div className="top">
          <div>
            ...
            <h2 className="h2 rv rv-d1">{t('home.work_title')}</h2>
          </div>
        ...
        <div className="pillars">
          <div className="pillar rv">
            <img src={IMG.pillar1} alt={t('home.pillar1_title')} />
          ...
          <div className="pillar rv rv-d1">
            <img src={IMG.pillar2} alt={t('home.pillar2_title')} />
            <div className="pillar-overlay">
          ...
          <div className="pillar rv rv-d2">
            <img src={IMG.pillar3} alt={t('home.pillar3_title')} />
            <div className="pillar-overlay">
      ...
      <section className="cheetah-run">
        ...
        <div className="cheetah-run-content">
          ...
          <h2 className="rv rv-d1">{t('home.run_title')}</h2>
      ...
      <section className="programs" id="programs">
        ...
        <h2 className="h2 rv rv-d1">{t('home.programs_title')}</h2>
      ...
      <section className="gallery-section" id="gallery">
        <div>
          ...
          <h2 className="h2 h2-light rv rv-d1">{t('home.gallery_title')}</h2>
        </div>
      ...
      <section className="volunteer-section" id="volunteer">
        ...
        <div className="vol-content">
          ...
          <h2 className="h2 rv rv-d1">{t('home.vol_title')}</h2>
      ...
      <section className="animals-section" id="animals">
        <div className="animals-header">
          ...
          <h2 className="h2 rv rv-d1">{t('home.animals_title')}</h2>
        </div>
      ...
      <section className="testimonials">
        ...
        <h2 className="h2 rv rv-d1">{t('home.testi_title')}</h2>

        <div className="testimonials-grid">
          {TESTIMONIALS.map((testi, i) => (
            <div key={testi.name} className={`testi-card rv rv-d${i + 1}`}>
              ...
              <div className="testi-author">
                ...
                <div>
                  ...
                  <div className="testi-location">{testi.location}</div>
                </div>
              </div>
            </div>
          ))}
      ...
      <section className="accom-section" id="accommodation">
        ...
        <h2 className="h2 h2-light rv rv-d1">{t('home.accom_title')}</h2>
          ...
          <div className="accom-right">
            {accomTitles.map((title, i) => (
              <div key={title} className={`accom-feature rv rv-d${i + 1}`}>
                <div className="accom-feature-icon">{accomIcons[i]}</div>
                <h4>{title}</h4>
                <p>{accomDescs[i]}</p>
              </div>
            ))}
      ...
      <section className="big-cta">
        ...
        <div className="big-cta-content">
          ...
          <h2 className="rv rv-d1">{t('home.cta_title')}</h2>
      ...
      <section className="contact-section" id="contact">
        ...
        <h2 className="h2 rv rv-d1">{t('home.contact_title')}</h2>
