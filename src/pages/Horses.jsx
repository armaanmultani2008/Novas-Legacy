      ...
      <>
        ...
        <div className="page-content">
          <div className="container">
            ...
            {/* ── GRIGLIA IMMAGINI RESPONSIVE SMART ── */}
            <div style={{
              display: 'grid',
              /* Si adatta da sola: 1 colonna su mobile, 2 colonne su desktop */
            ...
            <div style={{ height: '480px', overflow: 'hidden', position: 'relative', margin: '2.5rem 0' }}>
              <img src="/img/horse-project.png" alt="Waterberg Reserve" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
