            ...
            <div style={{
              ...
              {FIELDS.map((f, i) => (
                  ...
                  >
                    ...
                    <div style={{ padding: '1.2rem 1rem', display: 'flex', gap: '0.5rem', alignItems: 'center', flexGrow: 1 }}>
                      <span style={{ color: 'var(--gold)', fontSize: '0.6rem', flexShrink: 0 }}>{f.sym}</span>
                      <span style={{ fontSize: '0.88rem', fontWeight: 500, color: 'var(--dark)', lineHeight: 1.4 }}>{f.label}</span>
                    </div>
                  </div>
              ))}
            </div>
