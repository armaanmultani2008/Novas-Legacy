        ...
        <div className="page-content">
          <div className="container">
            ...
            <p>
              ...
              un impatto directo sulla vita degli animali che curiamo.
            </p>
            <p>
              ...
              {VOL_PHOTOS.map((p, i) => (
                  ...
                  >
                    <img
                        ...
                        onMouseLeave={e => { e.target.style.transform = 'none'; e.target.style.filter = 'brightness(0.85)'; }}
                    />
                    <div style={{
            ...
            <div className="vol-tasks" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '0.6rem 2rem', margin: '1.5rem 0 2.5rem' }}>
              {TASKS.map(t => (
              ...
              {SCHEDULE.map((s, i) => (
                  <div key={i} style={{ display: 'flex', gap: '1.5rem', padding: '1.2rem 0 1.2rem 2rem' }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '0.85rem', color: '#555', lineHeight: '1.55', fontWeight: 300 }}>{s.desc}</div>
                    </div>
                  </div>
              ))}
            </div>
